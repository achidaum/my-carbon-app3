...
with col1:
    ...
    st.markdown("#### 💡 พลังงาน")
    ac_hours = st.slider("เปิดแอร์วันนี้ (ชั่วโมง)", 0, 12, 0) # ปรับเหลือ 12 ชม.

with col2:
    st.markdown("#### 🍽️ การบริโภคอาหาร (3 มื้อ)")
    food_1 = st.text_input("มื้อเช้า", placeholder="เช่น ข้าวหมูแดง")
    food_2 = st.text_input("มื้อกลางวัน", placeholder="เช่น กะเพราไก่")
...
if st.button("ประเมินผลลัพธ์"):
    ...
    carbon_t = distance * ef_transport[transport]
    ...
    carbon_e = ac_hours * 0.51 # คาร์บอนจากแอร์
    ...
    # --- 4. ส่วนแนวทางลดและชดเชย (ที่นำกลับมา) ---
    st.markdown("---")
    st.markdown("### 💡 แนวทางลดการปล่อยก๊าซ (Reduction)")
    c1, c2 = st.columns(2)
    with c1:
        st.markdown("<div class='advice-card'><b>🚗 ด้านการเดินทาง</b><br>• ใช้รถสาธารณะหรือทางเดียวกันไปด้วยกัน<br>• ตรวจเช็คลมยางเพื่อประหยัดน้ำมัน</div>", unsafe_allow_html=True)
    with c2:
        st.markdown("<div class='advice-card'><b>🍽️ ด้านการบริโภค</b><br>• ลดมื้อที่มีเนื้อวัวลง<br>• ทานอาหารให้หมดเพื่อลดขยะอาหาร
